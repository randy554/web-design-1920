...
let selectDagenLabel        = document.querySelector("[for=dagen]");
let selectMaanden           = document.querySelector("#maanden");
let selectMaandenLabel      = document.querySelector("[for=maanden]");
let selectTijden            = document.querySelector("#tijd");
let selectTijdenLabel       = document.querySelector("[for=tijd]");
let selectOverTijden        = document.querySelector("#overTijd");
let selectOverTijdenLabel   = document.querySelector("[for=overTijd]");
let buttonAnders            = document.querySelector("#anders");
let andersLabel             = document.querySelector("[for=anders]");
let andersDatum             = document.querySelector("[for=andersDatum]");
let andersTijd              = document.querySelector("[for=andersTijd]");
let buttonOpslaan           = document.querySelector("#opslaan");
let buttonOpslaanLabel      = document.querySelector("[for=opslaan]");
...
window.onload = function (e) {
    ...
    selectDagenLabel.style.display = "none";
    selectMaandenLabel.style.display = "none";

    selectTijdenLabel.style.display = "none";
    // selectOverTijdenLabel.style.display = "none";

    andersDatum.style.display = "none";
    andersTijd.style.display = "none";


    // buttonOpslaanLabel.style.display = "none";
    // buttonOpslaan.style.display = "none";
...
buttonVandaag.addEventListener("focus", function (event) {
    ...
    selectOverTijdenLabel.style.display = "block";
    buttonOpslaanLabel.style.display = "block";
    datumElement.innerHTML = getDayMonthYear();
});
...
buttonMorgen.addEventListener("focus", function (event) {
    ...
    selectTijdenLabel.style.display = "block";
    buttonOpslaanLabel.style.display = "block";
...
buttonAnders.addEventListener('focus', function (event) {
    event.preventDefault();
    buttonAnders.style.backgroundColor = "black";
    buttonAnders.style.color           = "white";

    andersDatum.style.display = "block";
    andersTijd.style.display = "block";

    buttonOpslaanLabel.style.display = "block";

});

buttonAnders.addEventListener('click', function (event) {
    event.preventDefault();
    buttonAnders.style.backgroundColor = "black";
    buttonAnders.style.color           = "white";
...
buttonAnders.addEventListener('blur', function (event) {
    event.preventDefault();
    buttonAnders.style.backgroundColor = "white";
    buttonAnders.style.color           = "black";
